...
TIP_WRAPPERS_GENERIC = [
    "{tip}. The Commission opened a preliminary inquiry into the incident described above. The individual in question was asked to provide context. They said they could explain. They have not yet explained.",
    "{tip}. This was reviewed by the full Commission and flagged as actionable. The claim was cross-referenced with existing evidence and found to be corroborated on at least two points. The subject has since been described as cooperative, which is not the same as helpful.",
    "{tip}. Investigators confirmed the behavior described is consistent with patterns the Commission has been tracking. A follow-up interview was requested. The individual said they would need to check their schedule. Their schedule has not been checked.",
    "{tip}. The tip was forwarded to the lead investigator with no additional comment. She read it, stood up, walked to the window, and said: this one matters. No one asked her to clarify. The context was self-evident.",
    "{tip}. Commission analysts confirmed this is specific, credible, and in the words of one analyst, deeply unhinged in ways that are nonetheless completely relevant. A new sub-file was opened before end of day. The sub-file already needs a sub-file.",
    "{tip}. The Commission's response was swift. Within the hour, the incident described had been logged, categorized, and escalated. The individual involved has since called the Commission's characterization unfair. Their call has been added to the file.",
]

TIP_WRAPPERS_NICK = [
    "{tip}. Nick was informed this had been submitted and asked whether the account was accurate. He said parts of it were. He was asked which parts. He said the parts that make him look okay. He was told those parts appear to be limited. He agreed, reluctantly.",
    "{tip}. Commission auditors ran the numbers on what was described. The numbers do not support Nick's version of events. Nick has a different set of numbers. The Commission asked where his numbers came from. Nick said he worked them out himself. This has been added to the file.",
    "{tip}. Nick maintains that what happened is explainable. He has had multiple opportunities to explain it. His explanations have, to date, made the file larger rather than smaller. This is not typically how explanations work.",
    "{tip}. Nick's attorney reviewed the information and advised him not to comment. Nick commented anyway. His comment was a question: does this seem like something I would do? The Commission's answer was yes, in writing, with citations.",
]

TIP_WRAPPERS_HARRISON = [
    "{tip}. The Fraudfurter Division cross-referenced this against Harrison's known consumption history and found the claim to be, quote, uncomfortably plausible. Harrison called the cross-reference invasive. The Division noted that the consumption history only exists because Harrison created it and submitted it voluntarily in 2024. He is now asking for it back.",
    "{tip}. Agents reviewed what was described and noted that the item in question, if accurately identified, would represent a significant departure from competition protocol. Harrison said the item was misidentified. He was asked to identify it correctly. After a long pause, he said it was a sausage — in the tone of someone who does not entirely believe that.",
    ...
    "{tip}. Harrison denied that the events described took place. The FBI noted that his denial was issued before he was told what the tip said, which the Division described as either extremely innocent or extremely not. They have formed a working group. The preliminary conclusion is not the innocent one.",
]

TIP_WRAPPERS_TOM = [
    "{tip}. The Epween Files team flagged the activity described as consistent with what they have been monitoring under Operation High Volume. The item or substance mentioned, if confirmed, would represent a significant new data point. The team has been quietly excited about this development. Quietly is doing a lot of work in that sentence.",
    "{tip}. Tom was asked directly whether the events described are accurate. He said The Watcher observes and does not comment on observations. The investigator asked if that was a yes. Tom said The Watcher's response stands. It has been logged as a conditional admission. Tom disputes the characterization. His dispute has also been logged.",
    "{tip}. The item referenced above was identified by three Epween Files analysts independently and without coordination. All three reached the same conclusion. They shared their findings in a group message. The message contained no words. Just a single period. The period has been entered into the record.",
    "{tip}. The Commission forwarded this to the Epween Files archive. The archivist added it without comment, which colleagues noted was unusual — she normally has a comment. When pressed, she said only: this tracks. She was asked what it tracks. She said everything. She returned to the archive and closed the door.",
]

TIP_WRAPPERS_OWEN = [
    "{tip}. The Chorizogate task force confirmed the incident described is consistent with the activity they have been tracking since early June. The item in question has been logged as a new exhibit. Owen, when asked about it, said he had no memory of it. The task force noted he answered very quickly for someone with no memory.",
    "{tip}. Task force analysts found the submission corroborated by two existing exhibits. Owen has 4 weenies on the season. The task force now has evidence that may explain the gap between his actual performance and what has been entering his mouth. These are related concerns.",
    "{tip}. The item described has been sent to the Commission's evidence lab. Owen was asked if he recognized the description. He said it could be a lot of things. He was asked to name one. He named three things very quickly and then stopped. The investigator described this as telling. It has been classified as Exhibit 19: The Enumeration.",
    "{tip}. Owen's attorney called the information above speculative. The task force said it had a witness, a photograph, and a timestamp. The attorney asked if the timestamp was reliable. The task force said it was. The attorney went quiet. Owen also went quiet. Investigators described the next 45 seconds as the most informative of the entire Chorizogate proceeding.",
]
