...
TIP_WRAPPERS_GENERIC = [
    "The Weenie Tip Hotline received a call at an unspecified hour on a day the volunteer described as already weird. The caller stated: \"{tip}\". The volunteer wrote this down. She looked at what she wrote. She read it back aloud to confirm. The caller said yes, that is correct. There was a silence. The volunteer said she would forward it. She forwarded it. The Commission opened a file before she finished forwarding it.",
    "A tip arrived on the Hotline this week that the lead investigator described as, quote, one of the better ones. It read: \"{tip}\". The investigator read it to the full Commission. The room was quiet for a moment. Then someone said can you read that again. He read it again. Someone asked if it was admissible. The answer was yes. The room was quiet again.",
    "An anonymous caller reached the Weenie Tip Hotline and stated only: \"{tip}\". The call lasted 14 seconds. The caller hung up without providing a name. Commission analysts spent three hours reviewing the 14-second call. The call has been described as efficient and extremely concerning. It has been added to the master file under Tab T: Things We Cannot Unsee.",
    "The Hotline tip log was updated this week with a submission that analysts rated a 9 out of 10 on what they confirmed is a real internal scale. The tip: \"{tip}\". The scale goes to 10. The Commission noted they have never given a 10. They did not say whether this tip came close.",
    "The Weenie Tip Hotline volunteer who took this call asked to remain anonymous. She described the caller as calm, deliberate, and clearly not calling for the first time. The tip: \"{tip}\". The volunteer said after the call she went for a walk. She did not say why. The tip has been filed, stamped, and cross-referenced with six prior cases.",
    "This week the Hotline received what investigators are calling an actionable tip. The tip: \"{tip}\". The Commission defines actionable as a tip that causes us to stand up. Multiple Commission members stood up when this was read aloud. One walked to the window. She looked out the window for a while and did not explain why.",
]
TIP_WRAPPERS_NICK = [
    "The Nick file got heavier this week. A Hotline tip arrived stating: \"{tip}\". Nick was informed. Nick said he had never heard of that. His attorney said the same thing four seconds later, which investigators noted was too fast to be a coincidence. The tip has been added as Exhibit 31. The exhibit list now requires its own table of contents.",
    "The Supreme Weenie Commission received a Hotline tip that was read aloud to all senior investigators simultaneously. The tip: \"{tip}\". After the reading, there was a long silence. The lead investigator asked Nick to explain. Nick said he would like to speak to his lawyer. His lawyer was in the room. His lawyer also asked to speak to a lawyer.",
    "NICK CASE UPDATE: A new anonymous tip has been classified as highly material. It reads: \"{tip}\". Commission investigators who have been working this case for months described the tip as the missing piece. Nick described the tip as false, misleading, out of context, and written by someone who clearly has an agenda. The Commission noted all four of those words mean different things and asked Nick to pick one.",
    "The Hotline rang at 3:20am on a Thursday. The volunteer who answered was not expecting a call at 3:20am on a Thursday. The caller left a tip: \"{tip}\". The tip was forwarded to the Commission at 8am. By 8:04am, Nick had already heard about it. The Commission does not know how Nick already heard about it. Nick will not say. This is now part of the investigation.",
]
TIP_WRAPPERS_HARRISON = [
    "The FBI Fraudfurter Division received a Hotline tip that an agent described as, and I am reading directly from the file, deeply on-brand. The tip: \"{tip}\". Harrison was contacted for comment. Harrison said no comment. His attorney said no comment. Harrison's neighbor, who was not asked, also said no comment. The Division noted this was a lot of no comments for a routine tip.",
    "Fraudfurter Division analysts flagged an incoming Hotline tip for immediate review. The tip read: \"{tip}\". The tip was cross-referenced with the Wendy's receipts, the suspicious cylindrical protein report, and the smell testimony from Section 12. It was consistent with all three. The lead analyst filed a one-word status update: yep.",
    "Harrison case update: the Hotline received a submission this week that the Fraudfurter Division has described as the most compelling thing submitted since the spatula incident. The tip: \"{tip}\". Harrison reviewed the tip with his legal team for four hours. The legal team emerged and said they were still reviewing. They went back in. They have not come out.",
    "An anonymous tipster contacted the Hotline with information regarding the Harrison investigation. The tip: \"{tip}\". FBI analysts confirmed this is consistent with the Division's working theory, which they have described as the burger thesis. Harrison has repeatedly denied the burger thesis. His refrigerator, obtained via subpoena, has not.",
]
TIP_WRAPPERS_TOM = [
    "The Epween Files grew by 4 pages this week following a Hotline tip that archivists described as going straight to Tab G. The tip: \"{tip}\". Tab G is classified. The archivist who filed it signed a non-disclosure. She then asked if she could un-sign it. She was told no. She nodded slowly and went back to her desk. The desk is in the archive room. She has not left the archive room.",
    "A Hotline tip regarding Tom was escalated directly to the High Volume Unit without passing through standard review. The tip: \"{tip}\". The High Volume Unit sent it to the senior analyst. The senior analyst read it, walked to the supply closet that is now the Epween Files archive room, and stood inside it alone for eight minutes. He did not explain. He is the senior analyst. No one asked.",
    "The Epween Files archivist received a Hotline tip Tuesday evening and immediately began typing. She typed for 40 minutes. What she typed is 3 pages. The tip itself was one sentence: \"{tip}\". The other 2.5 pages are contextual cross-references, a timeline, and a personal note at the end that reads only: I knew it. She has been saying I knew it since page one.",
    "The Commission forwarded a Hotline tip to the Epween Files team with the subject line: please see attached. The tip: \"{tip}\". The team saw attached. The team met for two hours. The meeting notes say only CONSISTENT WITH PRIOR FINDINGS in bold, underlined, and somehow also in italics. The archive grew by 6 pages. Tom was not informed. The Commission agreed informing Tom would be, and this is a direct quote, counterproductive.",
]
TIP_WRAPPERS_OWEN = [
    "Chorizogate received a Hotline submission that the task force described as significant, timely, and honestly kind of obvious in retrospect. The tip: \"{tip}\". Owen was reached by phone. He said he was busy. He was asked with what. He said he would rather not say. The task force noted that is the third time this month Owen has been busy with something he would rather not describe. All three incidents are in the file.",
    "The Chorizogate evidence locker received a new entry Tuesday: a Hotline tip that investigators described as the kind of thing that makes you put down your coffee. The tip: \"{tip}\". Four investigators put down their coffee. One of them poured his into a plant. The plant is fine. Owen is not fine, legally speaking.",
    "An anonymous tipster advanced the Chorizogate investigation this week with a submission read aloud at the task force's Thursday briefing. The tip: \"{tip}\". Owen's attorney said the tip is unverified. The task force said they verified it in two hours. The attorney asked how. The task force said they would rather not say. The attorney filed a motion demanding they say. The motion was denied. The tip is verified.",
    "Chorizogate deepened today after the Hotline received what the lead investigator called the piece I have been waiting for. The tip: \"{tip}\". Owen was informed. Owen sat down. He had been standing. He sat down, looked at the floor, and said he needed a minute. He was given a minute. He asked for another minute. He was given one. He has been given eleven minutes total. He has not said anything in any of them.",
]
