...
(function() {
  ...
  function chompColor(c) { return c>=400?'#B22234':c>=200?'#002868':c>0?'#445580':'#c0c8d8'; }
    ...
    var totals={}, months={5:{},6:{},7:{},8:{},9:{}}, l7={}, l3={};
    var dayTot={}, dayBkd={}, logEntries=[];
    var maxTs=0, L7_MS=Date.now()-7*86400*1000, L3_MS=Date.now()-3*86400*1000;
    ...
    lines.forEach(function(line) {
      ...
      if (r.utcMs>=L3_MS) l3[r.name]=(l3[r.name]||0)+r.cnt;
    ...
    if (tb) {
      ...
      Array.from(tb.querySelectorAll('tr')).forEach(function(row) {
        ...
        var c=row.cells;
        if(c[0]) var l3v=l3[nm]||0; c[0].textContent=l3v>0?'\U0001F525':t>0?'\U0001F4C9':'\U0001F9CA';
