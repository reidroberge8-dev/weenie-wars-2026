...
PLAYERS = [
    ...
    {"name":"Tom",     "place":2, "total":22,"may":1,"june":21,"july":0,"aug":0,"sep":0,"l7":8, "chomp":346,"odds":"+400","move":"—","mc":"#7a8aaa"},
...
TOM_LOG = [{'date': 'Jun 22', 'text': 'Witnesses describe The Watcher as a single recliner positioned seven feet from a blank wall in a room with no other furniture. The wall has no artwork. There is one lamp. It faces away from the chair. Tom has denied 14 requests to photograph The Watcher. All 14 denials are in the Epween Files under Tab J: Denials.'}, {'date': 'Jun 21', 'text': 'The Epween Files index alone is 23 pages. Tab A: Origin. Tab B: Volume. Tab C: Methods. Tab D: Appliances Never Used. Tab E: The Watcher (preliminary). Tab F: The Watcher (confirmed). Tab G: The Watcher (classified). Tab G is sealed. Only the Supreme Weenie has clearance. She reviewed it once and has not discussed it since.'}, {'date': 'Jun 20', 'text': "The Epween Files were accidentally included in a document batch sent to Tom's dentist. The dentist called the Commission. He said he had assumed the dental wear was from grinding. He now believes it is from what he described as strategic uncooked consumption. He has requested a transfer to a different state."}]  # auto-filled by CI: newest first
HEADLINES = [{'icon': '📰', 'label': 'BREAKING', 'text': "The gap between Tom and Jon stands at 7 weenies. The Commission's analysts have been watching this number. It has been described as stubborn, meaningful, and uncomfortable to read aloud at press conferences.", 'date': 'Jun 22'}, {'icon': '🔥', 'label': 'HOT STREAK', 'text': "Momentum report: Tom has the hot hand at 8 over the last week. At this pace, the overall standings will shift by end of month. Tom's camp has declined to project by how much. The Commission estimates: considerably.", 'date': 'Jun 22'}, {'icon': '📊', 'label': 'STANDINGS', 'text': "Jon trails Tom by 7. In eating terms, that is 7 separate events. Jon's camp says they are not trailing. The Commission says subtraction does not care about camps. The gap is 7. It has been confirmed.", 'date': 'Jun 22'}, {'icon': '🕵️', 'label': 'INVESTIGATION', 'text': "The Harrison case entered a new phase after FBI analysts confirmed the smell coming from Harrison's alleged hot dog preparation area is not a hot dog smell and is instead consistent with either a hamburger or something that spent time near a hamburger and developed feelings about it.", 'date': 'Jun 22'}]  # auto-filled by CI: 4 headlines per day
...
BILLIONAIRE_DATA = [{'rank': 1, 'name': 'Elon Musk', 'worth_b': 1086.9, 'delta_b': -152.3}, {'rank': 2, 'name': 'Larry Page', 'worth_b': 286.5, 'delta_b': -14.5}, {'rank': 3, 'name': 'Sergey Brin', 'worth_b': 264.3, 'delta_b': -13.3}, {'rank': 4, 'name': 'Jeff Bezos', 'worth_b': 243.8, 'delta_b': -10.2}, {'rank': 5, 'name': 'Michael Dell', 'worth_b': 233.7, 'delta_b': -0.8}]  # auto-filled by CI
